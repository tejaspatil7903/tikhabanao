...
export default function Login() {
  ...
  // Scroll to form when coming from navbar
  useEffect(() => {
  ...
  return (
    <PageContainer className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600">
                Experience the perfect blend of quality and affordability with
                SmartServe
              </p>
      ...
      {/* Login Section */}
      <div ref={formRef} className="max-w-6xl mx-auto px-4 pb-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Login to access exclusive deals and start saving on your favorite
              meals.
            </p>
